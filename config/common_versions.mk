...
PRODUCT_BUILD_PROP_OVERRIDES += BUILD_DISPLAY_ID=LRX21V BUILD_ID=LRX21V BUILD_VERSION_TAGS=release-keys BUILD_UTC_DATE=0

# Versioning System
PRODUCT_VERSION_MAJOR = 1
PRODUCT_VERSION_MINOR = 0
PRODUCT_VERSION_MAINTENANCE = Beta-0.3
